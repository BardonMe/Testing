...
private slots:
    ...
    QString BuyAVO(QString OrderType, double Quantity, double Rate);
    QString SellAVO(QString OrderType, double Quantity, double Rate);
