...
{
	resize(900, 520);
	setWindowTitle(tr("Aevo Reborn") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About Aevo"), this);
...
{
	QString strTitle = tr("Aevo Reborn") + " - ";
